...
from brand_lookup import BrandProfile, brand_prompt_guidance
...
async def review_design(
    *,
    ...
    system = (
        ...
        "Approve only if the design is a good match; otherwise request a redo with "
        "concrete instructions an image model can follow. "
